...
import { getAdvancedKundaliReport, getBirthDetails, getAdvancedDailyHoroscope,getKundaliCompatibility,getKundaliReport } from "../../controllers/Astrologycontroller/astrologyController.js";
import { astrologyRateLimiter } from "../../middleware/ratelimiter.js";

const router = express.Router();

router.use(astrologyRateLimiter)
router.get("/daily-horoscope", getAdvancedDailyHoroscope);
